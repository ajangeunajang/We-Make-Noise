...
export default function TimetableHandler(){
    ...
    const handleDayClick = (index, dayData) => {
        ...
        if (element) {
            ...
            const offset = 13 * rootFontSize; // 13rem을 픽셀로 변환
        ...
        <div className="days">
                ...
                <div
                    ...
                    style={{ 
                        ...
                        //하이라이트박스의 width와 기준점 때문에 위치가 틀어져 보였음. width도 상수가 아니�� 동적으로 1/4 로 계산하는 식으로 변경!
                    }}
                />
            </div>
    )
